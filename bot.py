...
# Don't Remove Credit @commonthread, @rohit_1888
...
| (_| (_) | |) | _|| _|| |__ | | >  <| _ \ (_) || | \__ \
 \___\___/|___/|___|_| |____|___/_/\_\___/\___/ |_| |___/
        ...
        self.LOGGER(__name__).info(f"Bot Running..! Made by @commonthread")   
        ...
        try: await self.send_message(OWNER_ID, text = f"<b><blockquote> Bᴏᴛ Rᴇsᴛᴀʀᴛᴇᴅ by @commonthread</blockquote></b>")
        except: pass
